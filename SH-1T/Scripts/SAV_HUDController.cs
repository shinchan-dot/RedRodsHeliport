...
namespace SaccFlightAndVehicles
{
    ...
    public class SAV_HUDController : UdonSharpBehaviour
    {
        ...
        //** SH-1T **
        [Tooltip("Angle between magnetic north (HUD heading indicator) and true north (Unity's north)")]
        public float MagneticVariation = 0f;
        //** SH-1T **
        ...
        private void LateUpdate()
        {
            ...
            if (HeadingIndicator) { HeadingIndicator.localRotation = Quaternion.Euler(new Vector3(0, -VehicleEuler.y + MagneticVariation, 0)); }
            //** SH-1T **
            /////////////////
